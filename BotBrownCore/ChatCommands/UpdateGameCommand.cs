namespace BotBrown.ChatCommands
{
    ...
    public class UpdateGameCommand : BaseChatCommand
    {
        private readonly IEventBus eventBus;

        public UpdateGameCommand(IEventBus eventBus)
        {
        ...
        public override string[] Commands => new[] { "game" };
        ...
        public override Task ConsumeCommandSpecific(ChatCommandReceivedEvent chatCommandReceivedEvent)
        {
            ...
            {
                Title = null,
                Game = chatCommandReceivedEvent.CommandArgs
            };
